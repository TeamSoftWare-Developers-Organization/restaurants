# Generated by Django 6.0 on 2025-12-10 15:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('cash', 'نقدي'), ('credit_card', 'بطاقة ائتمان'), ('online_wallet', 'محفظة إلكترونية'), ('other', 'أخرى')], default='cash', max_length=20)),
