                                ...
                                <div className="bg-card dark:bg-card rounded-2xl border border-gray-100 dark:border-gray-800/40 shadow-sm p-6">
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-gray-100 dark:border-gray-800/40">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800 p-3 rounded-xl text-center min-w-[90px]">
                                                <span className="text-[10px] font-black text-gray-400 block">سعر البيع</span>
                                                <span className="text-sm font-black text-violet-600 tabular-nums">
                                                    {sellingPrice.toFixed(2)} <span className="text-[9px]">د.ل</span>
                                                </span>
                                            </div>
                                            <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800 p-3 rounded-xl text-center min-w-[90px]">
                                                <span className="text-[10px] font-black text-gray-400 block">تكلفة المكونات</span>
                                                <span className="text-sm font-black text-amber-600 tabular-nums">
                                                    {totalCost.toFixed(2)} <span className="text-[9px]">د.ل</span>
                                                </span>
                                            </div>
                                            <div className="bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-800/30 p-3 rounded-xl text-center min-w-[100px]">
                                                <span className="text-[10px] font-black text-emerald-600 dark:text-emerald-400 block">هامش الربح</span>
                                                <span className="text-sm font-black text-emerald-700 dark:text-emerald-300 tabular-nums">
                                                    {profitMargin.toFixed(2)} د.ل ({profitPercentage}%)
                                                </span>
                                            </div>
                                        </div>
                                    </div>
